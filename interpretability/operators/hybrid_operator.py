...
class HybridOperator(Operator, ABC):
    ...
    def top_p_heads(self, fv_map: HybridFVMap, top_p: float) -> map:
        """
        ...
        top_p_heads = fv_map.top_k_heads(top_k, all_attn_layers=self.attn_layers, all_scan_layers=self.scan_layers)
        return top_p_heads

...
class GPTNeoXLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        attn_output, attn_weights, attention = self.attention(
        ...
        if output_attentions:
            outputs += (attn_weights, attention)
...
class GPTNeoXModel(GPTNeoXPreTrainedModel):
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        all_attention_maps = () if output_attentions else None
        ...
        for i, layer in enumerate(self.layers):
            ...
            if output_attentions:
                all_attention_maps = all_attention_maps + (outputs[1],)
                all_attention_outputs = all_attention_outputs + (outputs[2],)
        ...
        output = BaseModelOutputWithPast(
            ...
            attentions=(all_attention_maps, all_attention_outputs) if output_attentions else None,
        )

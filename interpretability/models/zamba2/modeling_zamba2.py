    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if attention_override is not None:
            attn_hook, attn_override = attention_override
...
class Zamba2MambaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if attention_override is not None:
            scan_hook, scan_override = attention_override
            scan_output = scan_hook(scan_output, scan_override)

        self_attn_weights = None

        # residual connection after mamba
        hidden_states = residual + scan_output
...
class Zamba2Model(Zamba2PreTrainedModel):
    ...
    def forward(
        ...
        cache_position: Optional[torch.LongTensor] = None,
        attention_overrides: Optional[dict] = None
        ...
        for layer_idx, layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                layer_outputs = layer(
                    ...
                    use_cache=use_cache,
                    position_embeddings=position_embeddings,
                    attention_override=attention_overrides[layer_idx] if attention_overrides is not None else None,
                )
